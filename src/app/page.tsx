          ...
          <div className="border-line bg-line grid gap-px border md:grid-cols-2">
            {featuredFamilies.map((family, index) => (
              <Link
                ...
                className="motion-card group bg-canvas hover:bg-accent-light grid min-h-[16rem] content-between p-5 transition-colors sm:min-h-[18rem] sm:p-6 md:min-h-[21rem] md:p-7"
              >
          ...
          <div className="border-line bg-line grid gap-px border sm:grid-cols-2 lg:grid-cols-3">
            {featuredSpaces.map((space, index) => (
              <Link
                ...
                className="motion-card group bg-surface hover:bg-accent-light grid min-h-44 content-between p-5 sm:min-h-52 sm:p-6"
              >
          ...
          <div className="border-line bg-line grid gap-px border md:grid-cols-5">
            {applications.map((application, index) => (
              <Link
                ...
                className="motion-card group bg-surface hover:bg-accent-light grid min-h-40 content-between p-5 md:min-h-48"
              >
