...
export const mediaAssets = {
  productsMainHero: {
    id: "products-main-hero",
    category: "product-family-hero",
    kind: "image",
    src: "/media/hero/products-main-hero.png",
    alt: "Premium technology furniture product families arranged together, including a presentation station, mobile display stand, collaboration table and AV equipment enclosure",
    width: 1672,
    height: 941,
  ...
  spacesMainHero: {
    ...
    category: "space-hero",
    kind: "image",
    src: "/media/hero/spaces-main-hero.png",
    alt: "Modern technology-enabled workplace with collaboration table, lounge area, meeting room, display stand and integrated room control",
    width: 1672,
    height: 941,
    aspectRatio: "homepage-hero",
  ...
  sectorsMainHero: {
    ...
    category: "sector-hero",
    kind: "image",
    src: "/media/hero/sectors-main-hero.png",
    alt: "Connected technology furniture environments for education, workplace, public service and specialist operations sectors",
    width: 1672,
    height: 941,
    aspectRatio: "homepage-hero",
