      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            className="bg-brand-950/80 fixed inset-0 z-[100] p-0 sm:p-8"
            onMouseDown={(event) => {
            ...
            >
              ...
              <div className="border-line relative border-b">
                ...
                <input
                  ...
                  className="type-body-lg bg-surface text-graphite caret-accent placeholder:text-ink-muted min-h-20 w-full pr-5 pl-14 outline-none"
                />
              </div>
              <div
                  ...
                  {query && !loading && !results.length && (
                    ...
                    >
                      ...
                      <p className="type-body-sm text-ink-muted mt-3">
                        Check the spelling, try a broader product family, space
                        or sector, or contact Design Support for help.
                      </p>
                    </motion.div>
                  )}
                  {!query && (
                            ...
                            <li key={`${result.category}-${result.id}`}>
                              <Link
                                ...
                                className={cn(
                                  ...
                                  active === index && "bg-accent-light px-3",
                                )}
                              >
                                <span>
